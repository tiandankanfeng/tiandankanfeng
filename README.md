...
- [apache/maka](https://github.com/apache/maka) - Apache Maka (Incubating) is a high-performance agent workspace that keeps a complete record of everything it did. (2 weeks ago)
- [Carstin520/token-remain](https://github.com/Carstin520/token-remain) - A privacy-first macOS menu bar app for tracking AI coding quotas, reset times, token usage, and costs across 21&#43; tools. (2 weeks ago)
