...
- [kouchao/TiantianFundApi](https://github.com/kouchao/TiantianFundApi) - 天天基金网 Node.js API service, 东方财富, 基金api, 基金接口, 股票接口 (today)
- [x2rr/funds](https://github.com/x2rr/funds) - 自选基金助手是一款Chrome扩展，用来快速获取关注基金的实时数据，查看自选基金的实时估值情况 (today)
