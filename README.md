...
- [apache/maka](https://github.com/apache/maka) - Apache Maka (Incubating) is a high-performance agent workspace that keeps a complete record of everything it did. (1 day ago)
- [Carstin520/token-remain](https://github.com/Carstin520/token-remain) - A privacy-first macOS menu bar app for tracking AI coding quotas, reset times, token usage, and costs across 21&#43; tools. (1 day ago)
- [snap-research/locomo](https://github.com/snap-research/locomo) -  (2 days ago)
- [multica-ai/multica](https://github.com/multica-ai/multica) - Make humans and AI agents work as one team — open-source and self-hostable. (3 days ago)
