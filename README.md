...
- [wimdeblauwe/error-handling-spring-boot-starter](https://github.com/wimdeblauwe/error-handling-spring-boot-starter) - Spring Boot starter for configurable REST API error handling (2 days ago)
