...
- [devv-ai/devv](https://github.com/devv-ai/devv) - An AI-powered search engine for developers. (today)
- [linexjlin/GPTs](https://github.com/linexjlin/GPTs) - leaked prompts of GPTs (2 days ago)
- [vual/ChatGPT-Next-Web-Pro](https://github.com/vual/ChatGPT-Next-Web-Pro) - 基于chatgpt-next-web，增加了midjourney绘画功能，接入了stable-diffusion，已实现dall-e-3画图、gpt4-vision-preview识图、whisper语音转文字、tts文字转语音。正在增加注册登录，后台管理，接入知识库等。 (2 days ago)
